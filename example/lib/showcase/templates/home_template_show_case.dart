...
class HomeTemplateShowCase extends StatefulWidget {
  const HomeTemplateShowCase({super.key});

  @override
  State<HomeTemplateShowCase> createState() => HomeTemplateState();
}
